...
fun BottomNavBar(
    ...
    val navColors = KalkyNavigationBarDefaults.itemColors(
...
private fun RowScope.NavItem(
    ...
    currentPage: Int,
    onSceneSelected: (Int) -> Unit,
    colors: KalkyNavigationBarItemColors
) {
    KalkyNavigationBarItem(
...
@Composable
fun RowScope.KalkyNavigationBarItem(
    selected: Boolean,
    onClick: () -> Unit,
    ...
    colors: KalkyNavigationBarItemColors = KalkyNavigationBarDefaults.itemColors(),
...
@Stable
class KalkyNavigationBarItemColors internal constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        if (other == null || other !is KalkyNavigationBarItemColors) return false
...
@Immutable
object KalkyNavigationBarDefaults {
