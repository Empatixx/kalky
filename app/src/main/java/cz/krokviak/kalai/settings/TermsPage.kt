...
fun TermsPage(
    ...
    KalaiGradientBackground {
        Column(
            ...
            LegalBody(
                "Tyto obchodní podmínky upravují práva a povinnosti uživatelů mobilní aplikace Kalai " +
                "(dále jen \u201EAplikace\u201C). Používáním Aplikace souhlasíte s těmito podmínkami."
            )

            LegalSectionHeader("2. Popis služby")
            LegalBody(
                "Aplikace Kalai slouží k sledování příjmu potravin a nutričních hodnot. " +
