...
## UX Improvements
- **Onboarding Flow** - Guided setup for new users (profile, goals, tutorial)
...
## Technical
- **iOS App** - Native SwiftUI screens using shared KMP ViewModels
- **Cloud Sync** - Sync data across devices via backend
- **Food Analysis Backend** - Move from local to hosted AI service
